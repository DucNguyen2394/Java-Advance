package com.assignments.students;
        ...
        do{
            ...
            switch (choose){
                ...
                case 6:
                    ...
                    try {
                        fos = new FileOutputStream("C:\\Users\\HL2020\\IdeaProjects\\ADF2\\src\\student.txt");
                        for (Student std : studentList) {
                ...
                case 7:
                    ...
                    try {
                        fis = new FileInputStream("C:\\Users\\HL2020\\IdeaProjects\\ADF2\\src\\student.txt");
